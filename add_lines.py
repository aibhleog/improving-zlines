...
'''
Code used to add the lines into the zlines script (or any script, tbh).
import into code doing:

  import add_lines as ad # or whatever you want to call it in your code

Requires an axes variable, a y-axis value, and a redshift.

NOTES:
this is obviously a work in progress, and there are undoubtedly more pythonic
ways to do this... I just don't care enough yet haha
